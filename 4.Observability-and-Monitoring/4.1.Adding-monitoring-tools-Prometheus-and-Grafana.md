...
And with that we now have a Grafana dashboard, Prometheus metrics aggregator and our metrics scrapers! 

In the next exercise we will [explore our Temporal metrics](./4.2.Visualizing-Temporal-metrics-and-traces.md).
